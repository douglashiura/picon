...
public class TestPiconAtibutoLista {
	...
	public void umaListaVazia() throws Exception {
		...
		Assert.assertEquals(0, picon.getObjeto().size());
	}
	...
	public void umaListaUmAtributoVazio() throws Exception {
		...
		List<Entidade> lista = picon.getObjeto();
	...
	public void umaListaComConstrutorUmAtributoVazio() throws Exception {
		...
		store.add("mane", mane);
		PiconLista<EntidadeComConstrutor> picon = new PiconLista<EntidadeComConstrutor>(EntidadeComConstrutor.class, tokens, store);
		List<EntidadeComConstrutor> lista = picon.getObjeto();
		assertEquals(1, lista.size());
